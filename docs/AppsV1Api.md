...
# **get_apps**
> List[Application] get_apps(space_slug, org_slug, instance_slug, snapshot_slug)
...
with nuvolos_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_apps(space_slug, org_slug, instance_slug, snapshot_slug)
