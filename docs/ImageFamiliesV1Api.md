...
with nuvolos_client_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ImageFamiliesV1Api->update_image_family: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **ifid** | **int**|  | 
 **image_family_update** | [**ImageFamilyUpdate**](ImageFamilyUpdate.md)|  | [optional] 

### Return type

[**ImageFamily**](ImageFamily.md)
