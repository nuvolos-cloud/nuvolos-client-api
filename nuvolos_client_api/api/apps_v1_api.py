...
class AppsV1Api:
    ...
    def list_apps_options(
        ...
        _param = self._list_apps_options_serialize(
            org_slug=org_slug,
            space_slug=space_slug,
            instance_slug=instance_slug,
            snapshot_slug=snapshot_slug,
    ...
    @validate_call
    def list_apps_options_with_http_info(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        instance_slug: StrictStr,
    ...
    @validate_call
    def list_apps_options_without_preload_content(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        instance_slug: StrictStr,
    ...
    def _list_apps_options_serialize(
        self,
        org_slug,
        space_slug,
        instance_slug,
