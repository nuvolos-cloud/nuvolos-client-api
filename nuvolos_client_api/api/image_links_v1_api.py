...
class ImageLinksV1Api:
    ...
    def get_image_links(
        ...
        _param = self._get_image_links_serialize(
    ...
    @validate_call
    def get_image_links_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_image_links_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_image_links_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
