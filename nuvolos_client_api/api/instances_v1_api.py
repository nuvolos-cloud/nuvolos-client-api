...
class InstancesV1Api:
    ...
    def list_instances_options(
        ...
        _param = self._list_instances_options_serialize(
            org_slug=org_slug,
            space_slug=space_slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_instances_options_with_http_info(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def list_instances_options_without_preload_content(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        _request_timeout: Union[
    ...
    def _list_instances_options_serialize(
        self,
        org_slug,
        space_slug,
        _request_auth,
