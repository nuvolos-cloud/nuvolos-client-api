...
class LFSV1Api:
    ...
    def cleanup_lfs_share(
        ...
        _param = self._cleanup_lfs_share_serialize(
            org_slug=org_slug,
    ...
    @validate_call
    def cleanup_lfs_share_with_http_info(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        afsid: StrictInt,
    ...
    @validate_call
    def cleanup_lfs_share_without_preload_content(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        afsid: StrictInt,
    ...
    def _cleanup_lfs_share_serialize(
        self,
        org_slug,
        space_slug,
        afsid,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/lfs/v1/org/{org_slug}/space/{space_slug}/shares/{afsid}/cleanup',
    ...
    def list_lfs_shares(
        ...
        _param = self._list_lfs_shares_serialize(
            org_slug=org_slug,
            space_slug=space_slug,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_lfs_shares_with_http_info(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def list_lfs_shares_without_preload_content(
        self,
        org_slug: StrictStr,
        space_slug: StrictStr,
        _request_timeout: Union[
    ...
    def _list_lfs_shares_serialize(
        self,
        org_slug,
        space_slug,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/lfs/v1/org/{org_slug}/space/{space_slug}/shares',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
