...
class SpacesV1Api:
    ...
    def list_space_options(
        ...
        _param = self._list_space_options_serialize(
            slug=slug,
    ...
    @validate_call
    def list_space_options_with_http_info(
        self,
        slug: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_space_options_without_preload_content(
        self,
        slug: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _list_space_options_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
