...
class DeriveApp(BaseModel):
    """
    DeriveApp
    """ # noqa: E501
    image_tag: Optional[StrictStr] = None
    email_once_finished: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["image_tag", "email_once_finished"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email_once_finished": obj.get("email_once_finished") if obj.get("email_once_finished") is not None else True
        })
        return _obj
