...
class GroupInstanceCreateRequest(BaseModel):
    """
    ...
    editor_emails: Annotated[List[StrictStr], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["name", "slug", "description", "editor_emails"]
